...
import { faAnglesLeft, faAnglesRight, faArrowDown, faArrowRight, faBars, faCartShopping, faCheck, faChevronDown, faChevronLeft, faChevronRight, faDisplayChartUp, faDownload, faEdit, faLayerGroup, faPlus, faRocketLaunch, faSave, faTrash, faXmark } from '@fortawesome/pro-solid-svg-icons';
...
const BUTTON_ICONS: Partial<Record<IconName, IconDefinition>> = {
  ...
  [faRocketLaunch.iconName]: faRocketLaunch,
