  ...
  softwareSpecFields: TableFormField[] = [
    {
      ...
      columns: [
        ...
        { header: 'Status', getValue: item => lifecycleStatusLabel(item.lifecycleStatus ?? ''), width: 'w-28', type: 'status-badge', getStatus: item => lifecycleStatusBadgeVariant(item.lifecycleStatus) },
