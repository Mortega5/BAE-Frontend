...
import { SoftwareDeploymentDefinition } from 'src/app/models/software.model';
...
export class CreateProductSpecComponent implements OnInit, OnDestroy {
  ...
  private async getDeploymentType(spec: any): Promise<string | undefined> {
    ...
    const value = (Array.isArray(rawValue) ? rawValue[0] : rawValue) as SoftwareDeploymentDefinition | undefined;
    return value?.type;
  }
